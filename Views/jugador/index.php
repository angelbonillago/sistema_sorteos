...
<div class="container">
    <div class="row">
        ...
        <div class="col">
            <p><label for="selectSorteo">Sorteo :</label><br></p>

            <select  class="form-select" name="selectSorteo" id="selectSorteo">
            </select>
        ...
        <div class="col-md-12">
            <button class="btn btn-outline-primary" type="button" id="btnNuevoJugador" name="btnNuevoJugador">Nuevos jugadores</button>

            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover display nowrap" style="width: 100%;" id="tablajugadores">
