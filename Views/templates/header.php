...
<body>
    <div class="app align-content-stretch d-flex flex-wrap">
        <div class="app-sidebar">
            <div class="logo">
                <a href="<?php echo BASE_URL . 'admin' ?>" class="logo-icon"><span class="logo-text">Sorteador!</span></a>
            ...
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li class="active-page">
                        <a href="<?php echo BASE_URL . 'sorteos/sortear'; ?>" class="active">
                            <i class="material-icons-two-tone">casino</i>
                            Realizar Sorteo</a>
                    </li>

                    <li class="active-page">
                        <a href="<?php echo BASE_URL . 'sorteos'; ?>" class="active">
                            <i class="material-icons-two-tone">stars</i>
                            Sorteos</a>
                    </li>

                    <li class="active-page">
                        <a href="<?php echo BASE_URL . 'premios'; ?>" class="active">
                            <i class="material-icons-two-tone">redeem</i>
                            Premios</a>
                    </li>

                    <li class="active-page">
                        <a href="<?php echo BASE_URL . 'jugador'; ?>" class="active">
                            <i class="material-icons-two-tone">redeem</i>
                            Jugadores</a>
                    </li>
                                ...
                                <li class="nav-item hidden-on-mobile">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end notifications-dropdown" aria-labelledby="notificationsDropDown">
                                        ...
                                        <div class="notifications-dropdown-list">
                                            ...
                                            <a href="<?php echo BASE_URL . 'principal/cerrar_sesion' ?>">
                                                <div class="notifications-dropdown-item">
                                                    <div class="notifications-dropdown-item-image">
                                                        <span class="notifications-badge">
                                                            <img src="<?php echo BASE_URL . 'Assets/images/avatars/avatar.png' ?>" alt="">
